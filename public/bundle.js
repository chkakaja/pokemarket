...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageInput = __webpack_require__(170);
	    ...
	    value: function getMessages() {
	      ...
	      this.getMessagesAjax = setInterval(function () {
	        _jquery2.default.post('/getMessages', { user: window.userId, chatter: _this2.props.chatter }, function (messages) {
	          return _this2.setState({ messages: messages }, function () {
	            return console.log(_this2.state.messages);
	          });
	        });
	      }, 1000);
	    }
	...
	_reactDom2.default.render(_react2.default.createElement(MessageBox, null), document.getElementById('app'));
